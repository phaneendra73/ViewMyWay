    ...
    <div className="mb-6 relative">
      ...
      {type === 'password' && (
        <button
          ...
          className="absolute right-3 top-1/2 transform -translate-y-1/2 text-white focus:outline-none bg-transparent border-none p-0 hover:bg-black hover:text-white transition-opacity duration-200 "
          ...
          {showPassword ? (
            ...
            >
              <path
                ...
                fill="currentColor" // Change to use currentColor
              />
              <path
